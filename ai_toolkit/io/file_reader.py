...
class FileReader(AITool):
    ...
    def _process(self) -> (str | Dict[str, Any]):
        ...
        try:
            ...
            raise AINonRetryableError(f"File '{file_path}' could not be decoded with encoding '{file_encoding}'")
        except Exception as e:
            raise AINonRetryableError(f"Unknown error occurred when reading file '{file_path}': {e}")
